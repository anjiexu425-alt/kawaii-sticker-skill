...
│   ├── my-melody.md
│   │        示例档案：美乐蒂（My Melody）文字版风格与特征描述；纯文字、无任何官方素材（SPEC §4.2 / NOTICE.md）【characters】
│   └── .gitkeep
│           占位【本阶段】
│
├── adapters/
...
| characters | `character_profiles/README.md`、`character_profiles/_template.md`、`character_profiles/my-melody.md` |
